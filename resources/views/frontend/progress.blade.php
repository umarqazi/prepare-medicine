...
<div class="container-fluid">
    ...
    <div class="container">
        ...
        <div class="panel panel-white">
            ...
            <div class="m-auto">
                    <!-- Random Progress -->
                    <div class="container horizontal rounded box_design__">
                    @foreach ($random as $key=>$item)
                        <div class="horizontal block___">
                                <p class="bg-white text-dark heading__">Exam-{{ $key+1 }}</p>
                        <div class="progress-track">
                            <div class="progress-fill">
                            <span>{{ round( ($item->right_ans/$item->mockinfo_mockques->count())*100 )}}%</span>
                            </div>
                        </div>
                        ...
                        <tbody>
                            @foreach ($random as $key=>$item)
                                <tr>
                                    ...
                                    <td>Mock {{ $key+1 }}</td>
                                    <td>{{ $item->mockinfo_mockques->count() }}</td>
                                    <td>{{ $item->right_ans }}</td>
                                    <td>{{ $item->wrong_ans }}</td>
                                    <td>{{ $item->mockinfo_mockques->count()-($item->right_ans+$item->wrong_ans) }}</td>
                                    <td>{{ round( ($item->right_ans/$item->mockinfo_mockques->count())*100 )}}%</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
